...
require(
    ...
    function ( $, priceUtils, quote ) {
        ...
        var show_afterpay = afterpay_instalment_element.attr('showAfterpay'); 
        ...
        function setInstalment(afterpay_instalment_element, max_limit, min_limit)
        {
            ...
            if (parseFloat(product_variant_price) >= parseFloat(min_limit) && parseFloat(product_variant_price) <= parseFloat(max_limit) && show_afterpay ) {
